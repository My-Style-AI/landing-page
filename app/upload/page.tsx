  ...
  switch (id) {
    ...
    case "full-body":
      return (
        ...
        >
          <path
            d="M12 5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 3c-1.66 0-3 1.34-3 3v1h6v-1c0-1.66-1.34-3-3-3zm0 4h-3v8h2v-4h2v4h2v-8h-3z"
            fill={ICON_COLOR}
          />
        </svg>
      );
    case "front-facing":
      return (
        ...
        >
          <path
            d="M12 12.5c1.38 0 2.5-1.12 2.5-2.5s-1.12-2.5-2.5-2.5-2.5 1.12-2.5 2.5 1.12 2.5 2.5 2.5zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-2.67 0-5.17-.87-7.24-2.35.43-.94 1.44-1.62 2.49-1.62 1.66 0 2.75 1.34 2.75 3 0 .98-.4 1.86-1.03 2.51.98.32 2.03.46 3.03.46s2.05-.14 3.03-.46c-.63-.65-1.03-1.53-1.03-2.51 0-1.66 1.09-3 2.75-3 1.05 0 2.06.68 2.49 1.62C17.17 19.13 14.67 20 12 20z"
            fill={ICON_COLOR}
          />
        </svg>
      );
    case "standing":
      return (
        ...
        >
          <path
            d="M12 4c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm0 4c2.21 0 4 1.79 4 4v6H8v-6c0-2.21 1.79-4 4-4zm0 2c-1.1 0-2 .9-2 2v4h4v-4c0-1.1-.9-2-2-2z"
            fill={ICON_COLOR}
          />
        </svg>
      );
    case "background":
      return (
        ...
        >
          <path
            d="M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h18v14zM5 10h9v2H5v-2zm0 4h5v2H5v-2zm7 0h2v2h-2v-2z"
            fill={ICON_COLOR}
          />
        </svg>
      );
      ...
      {showWelcomeModal && (
        ...
        >
          ...
          <div
            ...
            aria-modal="true"
          >
            <div className="flex items-center justify-between px-4 pt-4 pb-2 border-b border-[#232f48]">
              <h2
              ...
              <button
                type="button"
                onClick={closeWelcomeModal}
                className="flex h-8 w-8 items-center justify-center rounded-full text-gray-400 hover:text-white hover:bg-[#232f48] transition-colors"
                aria-label="Close"
              >
          ...
          <>
            ...
            <div className="mb-4 space-y-6">
              ...
              <p className="text-gray-400 text-sm leading-relaxed text-center">
                Let&apos;s get your perfect look. Follow the guide above for
                best AI results.
              </p>
            </div>
              ...
              {preview ? (
                <div className="relative w-full h-full min-h-[220px]">
                  ...
                  <button
                    ...
                    className="absolute top-3 right-3 flex h-9 w-9 items-center justify-center rounded-full bg-[#ff4b4b] text-white shadow-lg shadow-black/40 active:bg-[#e03b3b]"
            ...
            {/* Actions - shown only after a photo is selected */}
              ...
              {file && (
                <>
                  <button
                    type="button"
                    onClick={clearSelection}
                    className="h-12 rounded-xl bg-[#ff4b4b] text-white text-sm font-semibold active:bg-[#e03b3b]"
                  >
                    Remove photo
                  </button>
                  <button
...
function UploadPageFallback() {
  return (
    <main className="min-h-dvh bg-[#0d0d0f] flex items-center justify-center">
      <div
        className="h-8 w-8 rounded-full border-2 border-[#feca57] border-t-transparent animate-spin"
        aria-hidden
      />
    </main>
  );
